...
plt.savefig('raw_data_pixel_dist_b.png')
plt.clf()
...
plt.savefig('normalized_data_pixel_dist_b.png')
plt.clf()
#######################################################
...
class CNN(Module):
	...
	def __init__(self, n_channels):
		...
		# third hidden layer
		self.hid3 = Conv2d(40, 40, (3,3))
		kaiming_uniform_(self.hid3.weight, nonlinearity='relu')
		self.act3 = ReLU()
		# third pooling layer
		self.pool3 = MaxPool2d((2,2), stride=(2,2))
		self.dp3 = Dropout2d(p=0.1)
		# fourth hidden layer
		self.hid4 = Conv2d(40, 40, (3,3))
		kaiming_uniform_(self.hid4.weight, nonlinearity='relu')
		self.act4 = ReLU()
		# fourth pooling layer
		self.pool4 = MaxPool2d((2,2), stride=(2,2))
		self.dp4 = Dropout2d(p=0.1)
		# fully connected layer
		self.hid5 = Linear(6*6*40, 100)
		kaiming_uniform_(self.hid3.weight, nonlinearity='relu')
		self.act5 = ReLU()
		# output layer
		self.hid6 = Linear(100, 2)
...
plt.savefig('mod2_loss_curve.png')
plt.clf()
