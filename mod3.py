...
#############################################################################
###dividing train-test datasets (using one dataset, let's say : npz-3 for testing and remaining datasets for training)

X_train = np.concatenate((a1,a2,a4,a5), axis=0)
X_train_lab = np.concatenate((lab1,lab2,lab4,lab5), axis=0)
...
plt.savefig('raw_data_pixel_dist_tr.png')
plt.clf()
...
plt.savefig('normalized_data_pixel_dist_tr.png')
plt.clf()
...
plt.savefig('mod3_loss_curve.png')
plt.clf()
